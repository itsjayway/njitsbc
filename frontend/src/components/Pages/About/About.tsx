    ...
    return (
        <div className="flex flex-grow flex-col md:flex-row gap-y-10 bg-gradient-to-b from-njit-navy to-njit-navy-dark text-gray-100 p-8 justify-center">
            <div className="flex flex-col gap-y-3 max-w-4xl px-10">
                ...
                <p className="text-xl">
                    To foster a welcoming and inclusive community for skaters of all levels at NJIT to overcome obstacles (literally and figuratively), develop multifaceted skills, and cultivate a love for the sport.
                </p>
            </div>
            <div className="max-w-4xl px-10">
                ...
                <div className="flex flex-col gap-y-4">
                    ...
                    <Testimonial
                        ...
                        author="Jibran A."
                        gradYear={23}
                        link="https://www.jibran.me"
                    />
                    <Testimonial
                        quote="The go to escape after bombing a calc 2 exam."
                        author="Michael H."
                        gradYear={23}
                        link="https://michaelhernando.com/"
                    />
                </div>
            </div>
        </div>
